...
export const Terminal = makeIcon('material-symbols:terminal-rounded');export const FolderAdd = makeIcon('ri:folder-add-fill');export const Sync = makeIcon('material-symbols:sync-rounded')
