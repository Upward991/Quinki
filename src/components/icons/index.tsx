...
export const Maximize = makeIcon('material-symbols:fullscreen-rounded')
export const Minimize = makeIcon('material-symbols:fullscreen-exit-rounded')
export const Checklist = makeIcon('material-symbols:checklist-rounded')
...
export const Terminal = makeIcon('material-symbols:terminal-rounded')
export const Bell = makeIcon('material-symbols:notifications-rounded')
export const BellOff = makeIcon('material-symbols:notifications-off-rounded')
export const Bookmark = makeIcon('material-symbols:bookmark-rounded');export const FolderAdd = makeIcon('ri:folder-add-fill');export const Sync = makeIcon('material-symbols:cloud-done-rounded')
