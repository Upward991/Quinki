...
import { Bot, Terminal, MessageSquare, Settings, Brain, Calendar } from '../icons'
...
const tabs = [
  ...
  {id:'calendar', icon:Calendar, label:'Agents Calendar', color:'var(--q-accent-calendar)', panel:'calendar', doubleBot:false},
