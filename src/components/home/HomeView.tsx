...
import { Bot, Terminal, MessageSquare, Settings, Brain, Checklist } from '../icons'
...
const tabs = [
  ...
  {id:'calendar', icon:Checklist, label:'Agents Tasks', color:'var(--q-accent-calendar)', panel:'calendar', doubleBot:false},
