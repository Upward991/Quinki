...
export class AgentSession {
     ...
     *
     * === Fase C.2: Dashboard disabilita completamente la compaction di Pi SDK. ===
     * La dashboard gestisce la compaction a 80% nel renderer (ChatArea).
     * Pi SDK non deve fare auto-compaction (né threshold né overflow recovery).
     * Gli errori di overflow vengono lasciati visibili nel messaggio per il renderer.
     */
    async _checkCompaction(assistantMessage, skipAbortedCheck = true) {
        // === Fase C.2: disabilitata completamente ===
        return false;
    }
    /**
